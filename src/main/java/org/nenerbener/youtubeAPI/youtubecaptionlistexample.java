...
public class ApiExample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            parameters.put("videoId", "M7FIvfx5J10");
            parameters.put("onBehalfOfContentOwner", "");

            YouTube.Captions.List captionsListRequest = youtube.captions().list(parameters.get("part").toString(), parameters.get("videoId").toString());
            if (parameters.containsKey("onBehalfOfContentOwner") && parameters.get("onBehalfOfContentOwner") != "") {
                captionsListRequest.setOnBehalfOfContentOwner(parameters.get("onBehalfOfContentOwner").toString());
            }

            CaptionListResponse response = captionsListRequest.execute();
